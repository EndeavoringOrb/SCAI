...
x = tf.keras.layers.Conv2D(16, 32, activation='tanh', padding="same", strides=(4,4))(input_layer)
x = tf.keras.layers.Conv2D(32, 64, activation='tanh', padding="same", strides=(2,2))(x)
#x = tf.keras.layers.Conv2D(64, 32, activation='tanh', padding="same", strides=(1,1))(x)
print("conv done")
...
trained = model.fit(my_training_batch_generator, epochs=1, verbose=1, validation_data=my_validation_batch_generator)
